	The "wholePipeLineForANewFileWithModelsTrained" has a pipeline which currently reads
...
for this reason. The files testSetIndexes has the order of the fingerprints that were
...
except for the substructure 298 which always gave an error.